 ...
 */
public class Email {
    static final String REMETENTE_NOME = "barbeariateste@yahoo.com";
    static final String REMETENTE_SENHA = "navalha1504";
    ...
    public void enviar (){
       ...
       try {
           ...
           email.addTo("didis.pavaneli@gmail.com");//por favor trocar antes de testar!!!!
